...
function formatarNomeLogin(nomeRaw) {
    ...
    nome = nome.replace(/\b(eskimo|eskimó|loja de fabrica|loja|fabrica|sorvetes|sorvete|de)\b/g, " ");
    nome = nome.replace(/[-–]/g, " "); 
...
document.getElementById('btnUploadModal').onclick = async () => {
    ...
    reader.onload = async (e) => {
        ...
        btn.innerText = "⬆️ Importar Tabela Aqui"; btn.disabled = false; fileInput.value = ""; 
    }; reader.readAsArrayBuffer(fileInput.files[0]);
};
