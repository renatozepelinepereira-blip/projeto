...
async function iniciar() {
    ...
    Object.keys(htmlBuffers).forEach(k => {
        ...
        if(tbody) tbody.innerHTML = htmlBuffers[k] || `<tr><td colspan="8" style="text-align:center; padding:20px;">Nenhum produto cadastrado.</td></tr>`;
    });
}
...
window.gerarExcelPedido = async () => {
    ...
    try { 
        ...
        btn.innerHTML = "<span style='font-size: 22px;'>⬇️</span> Gerar Pedido Excel"; 
        btn.disabled = false; 
    }
};
